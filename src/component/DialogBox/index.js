...
class DialogInput extends Component{
  constructor(props){
    super(props);
    this.state = { inputModal: this.props.initValueTextInput ? this.props.initValueTextInput : '', openning: true }
  }
  ...
  render(){
    ...
    var settingInitialValue = true;
    if (isDialogVisible && settingInitialValue) {
      settingInitialValue = false;
      this.inputModal = this.props.initValueTextInput
    }
          ...
          <TouchableOpacity style={styles.container} activeOpacity={1} onPress={() => { this.props.closeDialog(); this.setState({ inputModal: '',openning: true })}} >
            <View style={[styles.modal_container, {...dialogStyleProps}]} >
              ...
              <View style={styles.btn_container}>
                ...
                <TouchableOpacity  style={styles.touch_modal}
                  onPress={() => {
                    this.props.submitInput(inputModal);
                    this.setState({ inputModal: '',openning: true })
                  }}>
